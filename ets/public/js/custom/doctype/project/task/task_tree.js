...
frappe.treeview_settings['Task'] = {
	get_tree_nodes: "ets.docs.project.task.task.get_children",
	...
	onrender: function(node) {
		// console.log(node);
		if (node.data && node.data.budget!==undefined) {
			$('<span class="balance-area pull-right">'
				+  format_currency(Math.abs(node.data.budget), node.data.company_currency)
