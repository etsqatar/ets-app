frappe.ui.form.on('Stock Entry', {
	refresh: frm => {
        ...
        frm.set_value("task", frm.doc.set_project_task);
    ...
    before_cancel: frm =>{
		if(frm.doc.stock_entry_type == "Material Issue"){
			frappe.call({
				method: "ets.docs.stock.stock_entry.before_cancel",
				args: { "name": frm.doc.name, "task_name": frm.doc.set_project_task,  "amount": frm.doc.total_outgoing_value},
				callback: function (r) {
					console.log(r);
				}
			});	
